...
namespace Daryva.Services.Data
{
    public class NotificationRepository : INotificationRepository
    {
        ...
        public async Task DeleteNotificationsByTenancyIdAsync(int tenancyId)
        {
            var sql = "DELETE FROM Notification WHERE TenancyId = @TenancyId";
            await Task.FromResult(_dbContext.ExecuteNonQuery(sql, new { TenancyId = tenancyId }));
        }

        public async Task DeleteNotificationsByTenantIdAsync(int tenantId)
        {
            var sql = "DELETE FROM Notification WHERE TenantId = @TenantId";
