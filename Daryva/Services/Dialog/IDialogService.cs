namespace Daryva.Services.Dialog
{
    ...
    public interface IDialogService
    {
        ...
        /// </summary>
        System.Threading.Tasks.Task ShowMessageAsync(string message, string title = "Information");
        ...
        /// </summary>
        System.Threading.Tasks.Task<bool> ShowConfirmationAsync(string message, string title = "Confirm");
        ...
        /// </summary>
        System.Threading.Tasks.Task<string?> ShowOpenFileDialogAsync(string filter = "All Files|*.*", string title = "Select File");
        ...
        /// </summary>
        System.Threading.Tasks.Task<string?> ShowInputDialogAsync(string prompt, string title = "Input", string defaultValue = "");
    }
}
